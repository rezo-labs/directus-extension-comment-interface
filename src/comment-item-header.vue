<template>
	<div class="comment-header">
		<v-avatar x-small>
			<img v-if="avatarSource" :src="avatarSource" :alt="userName(activity.user, t)" />
...
import { getRootPath, userName, addTokenToURL } from './utils';
...
const avatarSource = computed(() => {
	...
	return addTokenToURL(getRootPath() + `assets/${props.activity.user.avatar.id}?key=system-small-cover`, api);
});
